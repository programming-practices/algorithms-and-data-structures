...
import algorithms.a_star.a2.datastructures.*;
...
public class AStar {
    ...
    public ISearchNode bestNodeAfterSearchVariable;
    ...
    public ISearchNode search(ISearchNode initialNode, IGoalNode goalNode) {
        ...
        while (openSet.size() > 0 && (maxSteps < 0 || this.numSearchSteps < maxSteps)) {
            ...
            if (goalNode.inGoal(currentNode)) {
                ...
                this.bestNodeAfterSearchVariable = currentNode;
                return currentNode;
            }
            //get successor nodes
        ...
        this.bestNodeAfterSearchVariable = closedSet.min();
        return null;
    }
    ...
    public ISearchNode bestNodeAfterSearch() {
        return this.bestNodeAfterSearchVariable;
    }
