 ...
 *
 */
class GraphCC<E extends Comparable<E>> {
	 ...
	 * 
	 * @param startNode
	 *            the starting Other.NodeTree from the edge
	 * 
	 * @param endNode
	 *            the ending Other.NodeTree from the edge
	 */
...
public class ConnectedComponent {
	...
	public static void main(String[] args) {
		GraphCC graphChars = new GraphCC();
		// Graph 1
