...
public class DFS{
	...
	/**
	 * Implementation in code of a data_structures.graphs.a2.DFS
	 * 
	 * @param a structure to be data_structures.graphs.a2.DFS'ed
...
//		Stack st=new Stack(vertices);         //operational stack
		...
		while(!st.isEmpty()){
			b[(byte)st.peek()]=(byte)0;                 //assigning waiting status
