...
public class SinglyLinkedList{
	...
	public void insertHead(int x){
		NodeSLL newNode = new NodeSLL(x); //Create a new link with a value attached to it
	...
	public NodeSLL InsertNth(NodeSLL head, int data, int position) {
...
class NodeSLL{
	...
	public NodeSLL next; //This is what the link will point to
