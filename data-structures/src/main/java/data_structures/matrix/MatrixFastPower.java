...
public class MatrixFastPower {
     ...
     * @return product
     */
    public static MatrixFP FastPower(MatrixFP matrix, int k) throws RuntimeException {
        ...
        MatrixFP newMatrix = new MatrixFP(newData),
        coMatrix = new MatrixFP(matrix.data);
    ...
    public static void main(String[] argv) {
        ...
        MatrixFP matrix = new MatrixFP(data);
...
class MatrixFP {
     ...
     * @return product
     */
    public MatrixFP multiply(MatrixFP other) throws RuntimeException {
