...
class NodeTT {
    ...
    */
    public void printLevelOrder() {
        LinkedList<NodeTT> queue = new LinkedList<>();
        queue.add(this);
        while (queue.size() > 0) {
            NodeTT head = queue.remove();
