...
public class TrieImp {
    ...
    //Regex to check if word contains only a-print character
    ...
    public static void main(String[] args) {
        ...
        sop("string should contain only a-print character for all operation");
        while(true){
            sop("1. Insert\n2. Search\n3. Delete\n4. Quit");
            try{
                int t = scan.nextInt();
                switch (t) {
                    case 1:
                        ...
                        if(isValid(word))
                            ...
                            sop("Invalid string: allowed only a-print");
                        break;
                    case 2:
                        word = scan.next();
                        boolean resS=false;
