...
/**
 * A utility to check if a given number is armstrong or not. Other.Armstrong number is
...
public class Armstrong {
	...
	/**
	 * Checks whether a given number is an armstrong number or not. Other.Armstrong
